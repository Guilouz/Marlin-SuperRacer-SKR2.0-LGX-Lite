...
<table border="0">
 ...
 <td>
 - Nécessite 4 vis M3x18 pour fixer la face avant et arrière de l'écran<br />
...
- Nécessite un anneau de LED (<a href="https://fr.aliexpress.com/item/32825718399.html">Lien</a>, ou <a href="https://fr.aliexpress.com/item/32466976963.html">Lien</a>, ou <a href="https://fr.aliexpress.com/item/33032787658.html">Lien</a>)<br />
 </td>
 </tr>
 <tr>
 <td>
 ...
 - Nécessite 2 ventilateurs 5015 (optionnels)<br />
 - Nécessite 2 vis M3x16 pour les ventilateurs 5015 (optionnels)<br />
 - Nécessite 2 vis M3x20 pour les ventilateurs 5015 (optionnels)
 </td>
 </tr>
 </table>
...
`G3 X0 Y-130 I130 Z0.3 E40 F1500`<br />
...
Ce firmware est configuré pour une carte mère BigTreeTech SKR 2.0 Rev. B avec MCU STM32F407VGT6 et extrudeur Bondtech LGX. Certains changements peuvent être effectués si vous disposez d'autres équipements.
  ...
  - Si ` HEATBLOCK Trianglelab CHC Pro (104NT-4-R025H42G)`, définissez ces valeurs :
    ...
    - Dans Configuration.h : `#define DEFAULT_Kp 13.0091`
    - Dans Configuration.h : `#define DEFAULT_Ki 1.9370`
    - Dans Configuration.h : `#define DEFAULT_Kd 21.8422`
