...
//#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_BED_TARGET      65     // (°C) Safe temperature for the bed after timeout
#endif
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH                1.3   // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP          0   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             35.0   // (mm/s) Default feedrate for retracting
